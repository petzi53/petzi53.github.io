...
subtitle: "Steady Decline with Two Crashes (2021 and 2024)"
description:  |
  In the last post, I provided a current overview of the global state of press
  freedom. It showed a continuous decline since 2002—the first year the Press
  Freedom Index was created—characterized by two significant 'crashes': 2021
  and (less pronounced) 2024. In this article, I attempt to go into more detail
  regarding the reasons for these declines.
author: "Peter Baumgartner"
date: "2026-09-08"
image: "press-freedom-sub-indicators-2023-2024.png"
image-alt: "A grouped bar chart titled 'Change in Press Freedom Sub-Indicators (2023 -> 2024).' The chart shows the change in score across five sub-indicators: Political, Economic, Legal, Social, and Safety, categorized by geographic zone. Most sub-indicators show a decline (negative change), particularly in the Political and Social categories. The 'Safety' indicator is the only one showing an overall positive trend in most zones, except for the Middle East & North Africa."
categories: [journalism, pressfreedom, pressfreedom.data, R]
...
Every year, RSF publishes its press freedom rankings as a fresh CSV, and every year the column names, category labels, and even some country-name spellings shift slightly. Reconciling 24 years of that into one analyzable table was a project of its own — I've written about the encoding problems ([Encoding Resilience](../2026-08-12-encoding-resilience/index.qmd)), the judgment calls involved in cleaning it ([When Data Cleaning Becomes Decision-Making](../2026-08-26-data-cleaning-decisions/index.qmd)), and the pipeline I eventually built to keep it updated without redoing the work by hand every year ([Automation versus Judgment Calls](../2026-08-28-automation-vs-judgement/index.qmd)).
...
I've also put together a companion [Shiny app](https://pbaumgartner-pressfreedom.share.connect.posit.cloud/) for exploring the same data interactively: trends by zone, drill-downs into individual countries, and a data export if you want to run your own analysis. If a claim in this post looks surprising, check it against the raw numbers.

Where 2022 and 2024 sit in the longer 2002–2026 trend — a sudden step down against an otherwise gradual slide — is covered with a chart in [the previous post](../2026-08-29-press-freedom-decline-overview/index.qmd); I won't repeat it here. What matters for this post are the reasons why these steps occurred.
...
```{r}
#| label: fig-world-map
#| fig-cap: "Press freedom score change by country, 2021→2022. Red indicates decline, green indicates improvement. Eastern Europe and Central Asia, and the Middle East and North Africa, show the most concentrated red."
#| warning: false
#| message: false
...
```{r}
#| label: fig-zone-bars
#| fig-cap: "Average press freedom score change by zone, 2021→2022. Middle East and North Africa shows the steepest average decline; EU and Balkans is the most resilient — but every zone declines on average."
#| warning: false
#| message: false
...
The map and the bar chart tell a consistent story, and it maps reasonably well onto RSF's four themes — though not in a one-to-one way:
...
1. **Geopolitical conflict** (Eastern Europe & Central Asia, and parts of Asia): the Ukraine invasion and its ripple effects — tightening control in Russia's sphere, direct threats to journalist safety in and around conflict zones.
2. **Democratic backsliding through legal and administrative tools** (Central Europe, parts of the Americas): governments using existing democratic institutions — broadcasting regulation, defamation law, advertising allocation — to squeeze independent media without overt censorship.
3. **Internal polarization without direct state action** (the United States, France, and similarly fractured media environments): a more diffuse process where trust in journalism erodes from fragmentation and hostility between audiences, not from a government decision.
...
With this additional data, the questions I can ask change. Instead of deriving mechanisms from qualitative reports, I can derive the change directly from the five measured dimensions.

### Change of Press Freedom Sub-Indicators 2021/2022

```{r}
#| label: fig-decomposition
#| fig-cap: "Change in press freedom sub-indicators, 2023→2024, by zone. Political context shows the steepest and most consistent decline; safety is the only dimension with net improvements in most zones."
#| warning: false
#| message: false
...
The grouped bar chart above compares changes in five sub-indicators – Political, Economic, Legal, Social, and Security – across six global zones and worldwide. Most sub-indicators show a negative change in most regions, except "Security," which shows a positive trend in most zones. The political dimension clearly contributed most to the overall decline.
...
If you'd like to check any of these numbers yourself, the [Shiny app](https://pbaumgartner-pressfreedom.share.connect.posit.cloud/) has the full country-level data and lets you rerun this kind of comparison for any pair of years.
...
coins_metadata <- "title='ctx_ver=Z39.88-2004&rft_val_fmt=info%3aofi%2ffmt%3akev%3amtx%3adc&rft.type=blogPost&rft.title=Two%20Crises%20of%20Press%20Freedom%3a%20Steady%20Decline%20with%20Two%20Crashes%20%282021%20and%202024%29&rft.date=2026&rft.source=Thought%20Splinters&rft_id=https://peter-baumgartner.net/posts%2f2026-09-08-crises-of-press-freedom%2findex&rft.description=In%20the%20last%20post%2c%20I%20provided%20a%20current%20overview%20of%20the%20global%20state%20of%20press%0afreedom.%20It%20showed%20a%20continuous%20decline%20since%202002%e2%80%94the%20first%20year%20the%20Press%0aFreedom%20Index%20was%20created%e2%80%94characterized%20by%20two%20significant%20%27crashes%27%3a%202021%0aand%20%28less%20pronounced%29%202024.%20In%20this%20article%2c%20I%20attempt%20to%20go%20into%20more%20detail%0aregarding%20the%20reasons%20for%20these%20declines.%0a&rft.au=Baumgartner%2c%20Peter'"
